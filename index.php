...
foreach ($lines as $line)
{
    ...
    if (in_array(trim($parts[1]), ['localhost', 'google-analytics.com', 'www.google-analytics.com']))
    {
        continue;
    }
    ...
    <div id="wrapper">
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="elkuku.jpg" width="36" height="36" alt="elkuku" style="float:left" /> El KuKu</a>
            </div>
